...
//below functions support SEEsh
int Check_child(int current_folder, char* child_name);  //return -1 if not find child, else return child's inode#
int Check_parent(int current_folder);  //return -1 if not find parent, else return parent's inode#
